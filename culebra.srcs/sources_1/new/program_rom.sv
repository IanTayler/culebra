...
module program_rom
	...
	always @* begin
        case (address_reg)
            ...
            //              LOAD    A         [PAD]            0
            'h00: memory = {5'h5, 3'h0, (WIDTH-8)'('b0), WIDTH'('h0)};
            //               XOR    A         [PAD]            15
            'h01: memory = {5'h4, 3'h0, (WIDTH-8)'('b0), WIDTH'('hf)};
            //               AND    A         [PAD]            10
            'h02: memory = {5'h2, 3'h0, (WIDTH-8)'('b0), WIDTH'('ha)};
            //               AND    A         [PAD]            8
            'h03: memory = {5'h2, 3'h0, (WIDTH-8)'('b0), WIDTH'('h8)};
            //              LOAD    P         [PAD]            0
            'h04: memory = {5'h5, 3'h5, (WIDTH-8)'('b0), WIDTH'('h0)}; // loop forever
            default: memory = 'h00;
        endcase
    end
